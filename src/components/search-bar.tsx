    ...
    return (
        <div className='inline-flex w-fit items-center justify-center '>
            <div className="flex rounded-full bg-primary px-2 w-full max-w-[600px]">
                <button className="self-center flex p-1 cursor-pointer bg-primary"> <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input
                    type="text"
                    className="w-full bg-primary flex bg-transparent pl-2 text-[#cccccc] outline-0"
                    placeholder="Search name movie or select options"
                />
                <button type="submit" className="relative p-2 bg-primary rounded-full">
